    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-4">
                ...
                <form action="{{ route('items.update', $post->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    {{-- Category --}}
                    <div class="form-group">
                        <select name="category" id="category" class="form-control @error('category') form-error-inline @enderror" value="{{ $post->category }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') form-error-inline @enderror" id="description" name="description" rows="3" placeholder="Tell us about the item or service you're listing...">{{ $post->description }}</textarea>
